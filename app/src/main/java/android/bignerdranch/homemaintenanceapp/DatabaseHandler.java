    ...
    class DatabaseHandler extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            String CREATE_MAINTENANCE_TRACKER_TABLE = "CREATE TABLE " + TABLE_TASKS + "("
                    + KEY_ID + " INTEGER PRIMARY KEY," + KEY_TASK + " TEXT," + KEY_ADDINFO + " TEXT" + ");";
         ...
         */
        public long addMaintenanceTask(MaintenanceTask task, int displayToDb) {
        ...
        public MaintenanceTask getMaintenanceTask(int id) {
            ...
            Cursor cursor = db.query(TABLE_TASKS,
                    new String[]{KEY_ID, KEY_TASK, KEY_ADDINFO},
                    KEY_ID + "=?",
        ...
        public List<MaintenanceTask> getAllMaintenanceTasks() {
            ...
            String selectQuery = "SELECT * FROM " + TABLE_TASKS + " ORDER BY " + KEY_TASK + " ASC";
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    task.setAdditionalInfo(cursor.getString(2));
                    taskList.add(task);
